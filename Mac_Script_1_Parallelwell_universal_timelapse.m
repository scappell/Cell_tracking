...
settings.projectpath=['/Users/Steve/Documents/Meyer_Lab/Data/Fucci Sensors/',settings.experiment_name,'/Data/']; %Path where this folder will get made
settings.imagepath='/Volumes/CAPP 5TB5/20160607-MCF10A-CDK12i/';  % Path where the images are stored
settings.shadingpath='/Users/Steve/Dropbox/Matlab Files/From Mingyu/BGimages/';  %path were a background noise image is located %%Optional
...
settings.bias_sig2_option=1; %1=correct for bleedthrough; 0=dont correct for bleedthrough;
settings.bias_sig3_option=1; %1=correct for bleedthrough; 0=dont correct for bleedthrough;
settings.shadingcorrection=1; %1=correct for shading; 0=dont correct for shading;
%%% Experiment parameters
settings.StartFrame=1;   %Frame to start analyzing from
settings.EndFrame=117;  %Frame to stop analyzing  %must be greater than StartFrame
...
if debug_mode==1 & manualcontrol==0;  %enter Debug mode to have the program stop running in the middle of the script
    Timelapse_Tracking_v1(rows(1),cols(1),sites(1),settings,debug_mode)
elseif debug_mode==1 & manualcontrol==1;
    Timelapse_Tracking_v1(manualwells(1,1),manualwells(1,2),manualwells(1,3),settings,debug_mode)
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numrows=length(rows);
...
parfor shot=1:shots
    ...
    try 
    %%% Timelapse %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Timelapse_Tracking_v1(row,col,site,settings,debug_mode)  %This is the engine of the analysis
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    catch
